...
const server = new Server(
  { name: "meta-analytics", version: "1.0.0" },
  { capabilities: { tools: {} } }
);
  ...
  tools: [
    {
      ...
      description:
        "Retorna resumo agregado das campanhas do Meta Ads por período. Agrupa por campanha, ad set ou anúncio com totais de spend, leads, CPL médio e CTR. Use para ter uma visão geral da performance.",
      inputSchema: {
        type: "object",
        properties: {
          start_date: {
          ...
          group_by: {
            ...
            description:
              "Nível de agrupamento: campaign (padrão), ad_set ou ad",
          },
        },
    ...
    },
    {
      ...
      description:
        "Retorna as melhores ou piores campanhas rankeadas por uma métrica. Use para identificar o que performa melhor e o que precisa ser otimizado ou pausado.",
      inputSchema: {
        type: "object",
        properties: {
          start_date: {
          ...
          metric: {
            ...
            description:
              "Métrica para ranking: leads (mais leads), cpl_asc (menor CPL = melhor), cpl_desc (maior CPL = pior), ctr, clicks, spend",
          },
          top_n: {
            type: "number",
    ...
    },
    {
      ...
      description:
        "Retorna a evolução diária de métricas de uma campanha específica. Use para analisar oscilações de performance, identificar quedas ou picos e entender sazonalidade.",
      inputSchema: {
        type: "object",
        properties: {
          campaign_name: {
    ...
    },
    {
      ...
      description:
        "Retorna estatísticas consolidadas de todo o período: investimento total, leads gerados, CPL médio, CTR médio, alcance e número de campanhas ativas. Ponto de partida para qualquer análise.",
      inputSchema: {
        type: "object",
        properties: {
          start_date: {
    ...
    },
    {
      ...
      description:
        "Consulta métricas brutas dia a dia de campanhas do Meta Ads. Use quando precisar de dados detalhados por data para análise específica ou exportação.",
      inputSchema: {
        type: "object",
        properties: {
          start_date: {
    ...
    },
    {
      ...
      description:
        "Compara métricas entre dois períodos de tempo (ex: esta semana vs semana passada, este mês vs mês anterior). Retorna variação percentual de cada métrica.",
      inputSchema: {
        type: "object",
        properties: {
          period_a_start: {
