          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Textarea rows={6} value={formData.initiationStrategy}
                onChange={(e) => setFormData({ ...formData, initiationStrategy: e.target.value })} className="focus-visible:ring-primary" />
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Textarea rows={6} value={formData.qualificationBoundary}
                onChange={(e) => setFormData({ ...formData, qualificationBoundary: e.target.value })} className="focus-visible:ring-primary" />
            </div>
          </CardContent>
        </Card>
